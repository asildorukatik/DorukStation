...
(function(root,factory){
  ...
  const RELEASES=[
    {version:'0.65',title:'DorukStationOS sync & external game media',changes:['Connected the web shell to the DorukStationOS bridge for apps, Wi-Fi, Bluetooth, controllers, storage and external media.','Library now uses Add a Game instead of an HTML-only importer, while OS helper apps stay hidden.','USB/CD/ISO games can appear temporarily on Home, be installed to DorukStation, and use the clockwise icon download/install mask.']},
